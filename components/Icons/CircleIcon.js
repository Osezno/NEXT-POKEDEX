...
const CircleIcon = (props) => {
    const { type, onClick, size, borderColor, color, invert , className} = props
    ...
    let contentRendered = <i className={classes.iconPrimary + " " +  className} onClick={onClick}></i>
    if (svg) {
        contentRendered = <i className={classes.primary  + " " + className} onClick={onClick}>
            {svg}
        </i>
    }
